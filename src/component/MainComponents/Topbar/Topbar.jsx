        ...
        <Box sx={{ display: "flex", justifyContent: "space-between" ,width:"96%"}}>
          ...
          <Box sx={{ display: "flex",width:"60%",justifyContent:"right" }}>
            ...
            <Dropdown
              title={t("more")}
              icon={<ExpandMoreIcon sx={{ fontSize: "1rem",mt:"auto" }} />} border="1"/>
              <Button sx={{color:"darkred",fontSize:"1rem",fontWeight:"500"}} onClick={()=>{localStorage.removeItem("validation")
            navigate("/")
            window.location.reload(false)}}>خروج</Button>
          </Box>
        </Box>
      </Box>
      {/* Search Box */}
        ...
        >
          <Button
            sx={{color:"white",
              ...
              fontWeight: "600",textTransform:"capitalize",letterSpacing:"1px"
            }}
            onClick={() => {              
              navigate("/");
            }}
